...
class RetinaFace_MobileNet(nn.Module):
    ...
    def forward(self, x):
        ...
        cls32 = cls32.view(batchsize, 2, -1, cls32_shape[3]) # torch.reshape(cls32, (batchsize, 2, -1, cls32_shape[3]))
        cls32 = self.face_rpn_cls_score_stride32_softmax(cls32)
        cls32 =   cls32.view(batchsize, 4, -1, cls32_shape[3])# torch.reshape(cls32, (batchsize, 4, -1, cls32_shape[3]))
        ...
        cls16 = cls16.view(batchsize, 2, -1, cls16_shape[3])# torch.reshape(cls16, (batchsize, 2, -1, cls16_shape[3]))
        cls16 = self.face_rpn_cls_score_stride16_softmax(cls16)
        cls16 = cls16.view(batchsize, 4, -1, cls16_shape[3]) #cls16 = torch.reshape(cls16, (batchsize, 4, -1, cls16_shape[3]))
        ...
        cls8 = cls8.view(batchsize, 2, -1, cls8_shape[3])# torch.reshape(cls8, (batchsize, 2, -1, cls8_shape[3]))
        cls8 = self.face_rpn_cls_score_stride8_softmax(cls8)
        cls8 = cls8.view(batchsize, 4, -1, cls8_shape[3]) #cls8 = torch.reshape(cls8, (batchsize, 4, -1, cls8_shape[3]))
